<div id="carta<?php echo $carta["Id"]; ?>" class="carta-enemigo" style="width:<?php echo $sizeCardBig["ancho"]; ?>px;height:<?php echo $sizeCardBig["alto"]; ?>px">
	...
	<div class="nivel-enemigo text-center text-nowrap font-casablanca"><?php echo $carta["Nivel"]; ?></div>
	...
	<table class="acciones-enemigo font-celestia-sc">
		<tr>
...
<script type="module">
	...
	textFit(document.getElementsByClassName('item-accion-enemigo'), {maxFontSize: 38, multiLine: false});
